    ...
    `;
      ...
      useEffect(() => {
        const interval = setInterval(() => {
          setTextIndex((prevIndex: number) => (prevIndex + 1) % devTexts.length);
        }, 5000);
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Hello! I'm Ahmad, a passionate web developer with over 6 years of
            ...
            <p className="text-gray-700 mb-8 leading-relaxed">
              ...
              experiences through clean code, intuitive design, and performance
              optimization. I'm constantly exploring new technologies and
              methodologies to enhance my skill set and deliver cutting-edge
              solutions.
            </p>
