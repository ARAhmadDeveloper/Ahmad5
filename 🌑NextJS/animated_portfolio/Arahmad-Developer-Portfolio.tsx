    ...
    <div className="min-h-screen bg-white text-gray-800 overflow-x-hidden">
      ...
      <div
        ...
        style={{
          ...
          transform: `translate(-50%, -50%) scale(${
            document.querySelectorAll(":hover").length > 0 ? 1.5 : 1
          })`,
        }}
      ></div>
      {/* Header */}
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 z-10 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <p className="text-lg text-blue-100 mb-10 max-w-2xl mx-auto md:mx-0 leading-relaxed opacity-0 animate-[fadeInUp_1s_0.9s_forwards]">
              Building sleek web & mobile experiences with React, Next.js, and
              Node.js. From zero to launch, I design, develop, and deploy
              solutions that just work — clean code, smooth UI, and modern tech
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-10 animate-bounce">
          <a
            href="#about"
            className="text-white opacity-75 hover:opacity-100 transition-opacity duration-300 cursor-pointer"
          >
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Hello! I'm Ahmad, a passionate web developer with over 6 years
                of experience creating beautiful, functional, and user-centered
                digital experiences. Based in San Francisco, I combine technical
                expertise with creative problem-solving to build websites and
                applications that deliver results.
              </p>
              <p className="text-gray-700 mb-8 leading-relaxed">
                My approach to development focuses on creating seamless user
                experiences through clean code, intuitive design, and
                performance optimization. I'm constantly exploring new
                technologies and methodologies to enhance my skill set and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                ...
                collaborations? Feel free to reach out through the form or using
              ...
              <div className="mt-8 flex space-x-4">
                <a
                  href="#"
                  className="bg-gray-800 hover:bg-blue-600 w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300 cursor-pointer"
                >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} arahmaddeveloper. All rights
              reserved.
            </p>
